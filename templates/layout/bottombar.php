<nav class="bottom-nav" aria-label="Mobile navigation menu">
    <ul>
        ...
        <li>
            <a href="<?= BASE_URL ?>/games" aria-label="Games">
        ...
        <li>
            <a href="<?= BASE_URL ?>/leaderboards" aria-label="LeaderBoards">
        ...
        <li>
            <?php if(!empty($username)): ?>
                <a href="<?= BASE_URL ?>/profile" aria-label="Your profile">
                    
                </a>
            <?php else: ?>
                <a href="<?= BASE_URL ?>/login" aria-label="Login or Sign up">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-log-in-icon lucide-log-in"><path d="m10 17 5-5-5-5"/><path d="M15 12H3"/><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/></svg>
                </a>
            <?php endif; ?>
        </li>
    </ul>
